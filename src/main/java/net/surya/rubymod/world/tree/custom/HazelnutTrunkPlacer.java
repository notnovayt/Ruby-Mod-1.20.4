...
public class HazelnutTrunkPlacer extends TrunkPlacer {
    public static final Codec<HazelnutTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, HazelnutTrunkPlacer::new));

    public HazelnutTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
        super(baseHeight, firstRandomHeight, secondRandomHeight);
    }

    @Override
    protected TrunkPlacerType<?> getType() {
        return ModTrunkPlacerTypes.HAZELNUT_TRUNK_PLACER;
    }
